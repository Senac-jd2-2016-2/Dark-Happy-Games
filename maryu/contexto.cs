...
namespace maryu
{
    class Contexto
    {
        ...
        public static void inicializar(ContentManager content)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                Tiles rect = new Tiles(0, 500);
                tijolinhos.Add(rect);
                if (i == 1)
                {
                    Tiles rect1 = new Tiles(50, 500);
                    tijolinhos.Add(rect1);
                }
                if (i == 2)
                {
                    Tiles rect3 = new Tiles(100, 500);
                    tijolinhos.Add(rect3);
                }
                if (i == 3)
                {
                    Tiles rect2 = new Tiles(150, 500);
                    tijolinhos.Add(rect2);
                }
                if (i == 4)
                {
                    Tiles rect4 = new Tiles(300, 500);
                    tijolinhos.Add(rect4);
                }
                if (i == 5)
                {
                    Tiles rect5 = new Tiles(350, 500);
